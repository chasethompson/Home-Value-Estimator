# Estimate Home Value - Predicting Home Prices Using Linear Regression

### *The Report*

> Here's the link to the deliverable report requested from the team. It contains the slides, but not the verbal portion of the presentation. https://drive.google.com/file/d/1eMrsrx6Vs1rHDuicfFpt9uNJNoz8g3LU/view?usp=sharing
...
* Photoshop (create gif for heatmap layer from gmaps)
***
...
* Heat map of the location drill down for home values

![home value heat map](map_zillow.gif)

* A plot of the residuals for the linear model that beat the baseline

![residual plot](residual.png)

* Tax Distribution Graphs

![la county tax rate](la.png)
![orange county tax rate](orange.png)
![ventura county tax rate](ventura.png)